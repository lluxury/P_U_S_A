...
class SnmpController(object):
    ...
    def run(self):
        ...
        p = optparse.OptionParser(description = "A tool that determines memory installed", prog = "memorator", version = "memorator 0.1.0a" usage = "%prog [subnet range] [options]")
            ...
            for arg in arguments:
                try:
                    ...
                    for i in ips:
                        ...
                        session = SnmpSession(options.oid, DestHost = ipAddr, Community = options.community)
...
#故障中,仅供参考 2.7, 有机会重写
#./memory_tool_netsnmp.py 10.0.1.2 10.0.1.20
#./memory_tool_netsnmp.py -o sysDescr 10.0.1.2 10.0.1.20
